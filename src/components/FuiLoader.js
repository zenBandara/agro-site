...
const FuiLoader = () => {
    return (
        <div className="svg-frame1">
            {/* Paste the entire HTML content of the loader here */}
            <div className="svg-frame">

                {/*base*/}
                <svg className='svg-loader' style={{ '--i': 0 }}>
                    <g className="big-outter">
                        <g className="squares">
                            <path className="ellipse" d="M383.931 285.267C374.922 309.242 360.656 330.88 342.188 348.583C323.72 366.285 301.522 379.599 277.234 387.541" stroke="#00AAFF" stroke-width="6" stroke-linecap="square" stroke-dasharray="1 15" />
                        </g>
                        <g className="bottom-dots">
                            <path className="ellipse" d="M368.63 350.215C350.6 370.742 328.367 387.15 303.437 398.328C278.508 409.505 251.466 415.189 224.146 414.995C196.827 414.801 169.868 408.733 145.1 397.202C120.332 385.672 98.3341 368.949 80.5984 348.168" stroke="#00AAFF" stroke-width="2" stroke-linecap="square" stroke-dasharray="1 15" />
                            <path className="ellipse" d="M345.779 148.085C360.806 171.738 368.526 199.298 367.972 227.315C367.419 255.333 358.616 282.566 342.666 305.607" stroke="#00AAFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="0.5 15" />
                        </g>
                        <g className="top-dots">
                            <path className="ellipse" d="M92.4362 117.897C75.3686 139.201 63.6658 164.291 58.3117 191.059C52.9576 217.826 54.1089 245.488 61.6686 271.718" stroke="#00AAFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="0.5 15" />
                            <path className="ellipse" d="M251.126 44.8182C226.015 41.2368 200.432 42.9587 176.027 49.8728" stroke="#00AAFF" stroke-width="2" stroke-linecap="square" stroke-dasharray="0.5 15" />
                            <path className="ellipse" d="M300.89 118.301C274.736 99.5021 242.549 91.1476 210.597 94.8638" stroke="#00AAFF" stroke-width="4" stroke-linecap="square" stroke-dasharray="0.5 15" />
                        </g>
                        <g className="ellipse-12">
                            <mask id="path-20-inside-6_115_2" fill="white">
                                <path d="M225.5 22C240.73 22 255.911 23.7181 270.755 27.1217L269.171 34.0299C254.846 30.7455 240.197 29.0875 225.5 29.0875" />
                            </mask>
                            <path d="M225.5 22C240.73 22 255.911 23.7181 270.755 27.1217L269.171 34.0299C254.846 30.7455 240.197 29.0875 225.5 29.0875" stroke="#00AAFF" stroke-width="8" mask="url(#path-20-inside-6_115_2)" />
                        </g>
                        <g className="ellipse-11">
                            <mask id="path-21-inside-7_115_2" fill="white">
                                <path d="M76.2195 83.2711C89.0537 69.7053 103.677 57.9521 119.686 48.3363L125.449 57.9312C110.312 67.0233 96.4854 78.1363 84.3502 90.9633L76.2195 83.2711" />
                            </mask>
                            <path d="M76.2195 83.2711C89.0537 69.7053 103.677 57.9521 119.686 48.3363L125.449 57.9312C110.312 67.0233 96.4854 78.1363 84.3502 90.9633L76.2195 83.2711" fill="#00AAFF" stroke="#00AAFF" stroke-width="8" mask="url(#path-21-inside-7_115_2)" />
                        </g>
                    </g>
                    <circle className="base" cx="228.5" cy="224.5" r="202" stroke="#00AAFF" />
                    <mask id="path-2-inside-1_115_2" fill="white">
                        <path d="M165.046 416.801C208.726 431.214 256.011 430.328 299.119 414.287C342.228 398.247 378.591 368.008 402.224 328.548C425.858 289.088 435.354 242.758 429.149 197.183C422.944 151.607 401.408 109.502 368.086 77.7961L363.102 83.0341C395.235 113.608 416.001 154.21 421.985 198.158C427.968 242.106 418.811 286.782 396.022 324.833C373.232 362.884 338.167 392.043 296.36 407.913C254.553 423.783 208.505 425.917 166.049 413.042" />
                    </mask>
                    <path d="M165.046 416.801C208.726 431.214 256.011 430.328 299.119 414.287C342.228 398.247 378.591 368.008 402.224 328.548C425.858 289.088 435.354 242.758 429.149 197.183C422.944 151.607 401.408 109.502 368.086 77.7961L363.102 83.0341C395.235 113.608 416.001 154.21 421.985 198.158C427.968 242.106 418.811 286.782 396.022 324.833C373.232 362.884 338.167 392.043 296.36 407.913C254.553 423.783 208.505 425.917 166.049 413.042" stroke="#00AAFF" stroke-width="10" mask="url(#path-2-inside-1_115_2)" />
                </svg>

                {/*big centro*/}
                <svg className='svg-loader' style={{ '--i': 1 }}>
                    <g className="big-centro">
                        <circle className="ellipse-19" cx="227.5" cy="224.5" r="158" stroke="#00AAFF" />
                        <g className="ellipse-29">
                        ...
                        <circle className="ellipse-44" cx="227.5" cy="224.5" r="150" stroke="#00AAFF" />
                    </g>
                </svg>


                {/*solo lines*/}
                <svg className='svg-loader' style={{ '--i': 2 }}>
                    <g className="solo-lines">
                        <g className="left-line">
                ...
                {/*outter center*/}
                <svg className='svg-loader' style={{ '--i': 3 }}>
                    <g className="outter-center">
                        <g className="Ellipse-33">
                ...
                {/* Center */}
                <svg className='svg-loader' style={{ '--i': 5 }}>
                    <g className="center">
                        <path
                            id="center_2"
